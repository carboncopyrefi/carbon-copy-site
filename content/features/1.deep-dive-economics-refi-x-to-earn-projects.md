...
[Sweatcoin](https://www.businessofapps.com/data/sweatcoin-statistics/){target="_blank"}, established in 2014, is a pioneering "move-to-earn" (X2E) project that incentivises physical activity by rewarding users with sweatcoins for their steps. 1 With a current user base of 190 million, it stands as the oldest sustainability-focused X2E platform. Its unique position, operating within both Web2 and Web3 ecosystems, provides a valuable case study for understanding the challenges and limitations inherent in X2E projects.
