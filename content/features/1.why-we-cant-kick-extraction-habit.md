...
description: How have we become so comfortable with a system that promotes social inequality and ecological degredation?
category: Opinion
...
Capitalism, a system built on exploitation and inequality, ultimately derived from these extractive practices. Despite our awareness of its detrimental effects, remains entrenched as the global economic order. This should be alarming, especially given the pace of climate change, rampant deforestation for urbanisation, and rate of species extinction. Instead, the prevailing attitude is complacency.

This led me to wonder: How have we become so comfortable with a system that promotes social inequality and ecological degredation? My research revealed a troubling truth: we're stuck with extractive capitalism, and there's very little we can do about it.
