...
<template>
    ...
    <div class="row mt-4">
      ...
      <div class="col-lg-6">
        ...
        <div v-else class="row">
          <h3 class="mt-4">Recycling & Solar Energy</h3>
          <ClientOnly>
          ...
          <ClientOnly>
            <DashboardFigure metric_key="solar-energy-generated" :data="data.aggregate" bg_color="#BEBAF5" metric_note="The amount of solar energy generated by Impact DePIN projects." />
          </ClientOnly> -->
        </div>
