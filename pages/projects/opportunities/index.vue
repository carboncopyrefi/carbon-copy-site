<script setup lang="ts">
    ...
    useHead({
        ...
        meta: [
            ...
            { name: 'description', content: 'A curated list of opportunities in the Web3 regenerative finance (ReFi) space.' },
            { property: 'og:description', content: 'A curated list of opportunities in the Web3 regenerative finance (ReFi) space.' },
            { property: 'og:title', content: 'ReFi Opportunities | CARBON Copy' },
            { name: 'twitter:description', content: 'A curated list of opportunities in the Web3 regenerative finance (ReFi) space.' }
        ]
    })
